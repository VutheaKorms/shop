...
angular.module('app')
    ...
    .controller('BrandCtrl', function(dataFactory,$scope, $state, $stateParams, Notification) {
        ...
        $scope.saveAdd = function(){
            $scope.loading = true;
            dataFactory.httpRequest('api/brands/post','POST',{},$scope.form).then(function(data) {
        ...
        $scope.edit = function(id){
            dataFactory.httpRequest('api/brands/edit/'+id).then(function(data) {
                $scope.form = data;
            });
        }
        ...
        $scope.saveDelete = function(){
            $scope.loading = true;
            dataFactory.httpRequest('api/brands/'+ $scope.form.id ,'DELETE').then(function(data) {
                $(".modal").modal("hide");
