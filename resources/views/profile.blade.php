        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            @else
                ...
                <div class="panel-body">
                    ...
                    Your first name is: {{ $user->email }}
                    Your last name is: {{ $user->name }}
                </div>


                <li class="dropdown" style="cursor: pointer; cursor: hand;">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                        {{ Auth::user()->id }} <i class="fa fa-user fa-fw"></i>  <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a class="nav-link" href="/admin/dashboard/profile"><i class="fa fa-user fa-fw"></i> User Profiles</a>
                        </li>
